...
public sealed class BuildWindowsTask : FrostingTask<BuildContext>
{
    ...
    public override void Run(BuildContext context)
    {
        ...
        context.StartProcess("cmake", new ProcessSettings { WorkingDirectory = buildDir, Arguments = "-S ../../ -A x64 -D CMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded -DSDL3_INCLUDE_DIRS=../../../sdl/include" });
        ...
        context.CreateDirectory(buildDir);
        context.StartProcess("cmake", new ProcessSettings { WorkingDirectory = buildDir, Arguments = "-S ../../ -A ARM64 -D CMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded -DSDL3_INCLUDE_DIRS=../../../sdl/include" });
        context.StartProcess("msbuild", new ProcessSettings { WorkingDirectory = buildDir, Arguments = "sdl2_compat.sln /p:Configuration=Release" });
        context.CopyFile($"{buildDir}/Release/SDL2.dll", $"{context.ArtifactsDir}/win-arm64/SDL2.dll");

        // Build sdl3 ARM64
        buildDir = "sdl/build-arm64";
        context.CreateDirectory(buildDir);
